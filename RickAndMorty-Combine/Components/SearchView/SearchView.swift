...
class SearchView: UIView {
    ...
    private lazy var tfSearch: UITextField = {
        ...
        textField.layer.borderColor =  UIColor(named: "LabelColor")?.cgColor
    ...
    private lazy var imgSearch: UIView = {
        let tempView = UIView()
        let tempImageView = UIImageView(image: UIImage(systemName: "magnifyingglass")?.withTintColor(UIColor(named: "LabelColor")!))
        tempImageView.tintColor = UIColor(named: "LabelColor")
